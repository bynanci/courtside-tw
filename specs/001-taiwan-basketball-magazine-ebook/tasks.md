...
- [x] T081 Implement database/media-metadata backup and isolated restore verification in `infra/deployment/backup/`, `scripts/operations/restore-verify.sh`, and `docs/operations/disaster-recovery.md`; capture evidence for RPO 24h/RTO 4h and sampled checksum validation. Completion proof: PR #118 exact implementation head 0eb9f5d70b35d0578e7218b24c3e7a2f8f852f17; CI #815 (run 32389968079) and Security #817 (run 32389968075) passed; artifact 9414504550 SHA-256 c45c6005ef77b90e906c7924e68173434f74cee64bda62f030f2e1f0aaaec33c; isolated PostgreSQL drill verified 2 media assets/2 variants, 2/2 metadata rows, 2/2 SHA-256 sample, RPO 0h <=24h, RTO 0.008m <=240m, explicit target confirmation, and release_ready=true; T082+ remained out of scope.
