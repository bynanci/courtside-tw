...
- Exact reviewed base: `main@ac92f88a7267736325519a8bf12dc6b9ee2bcb86`.
- Canonical receipt count: **86 checked / 26 unchecked**. Completed: T001–T085 and T097. Pending: T086–T096 and T098–T112.
- Previously accepted completion receipts remain historical evidence; phrases such as “T083/T084 remain unchecked” describe their receipt date, not today's frontier. This review does not rerun every historical test.
- T085 records a completed traceability audit. The 18 beta-risk adjudications in [#160](https://github.com/bynanci/courtside-tw/issues/160#issuecomment-5618664464) do not mark the underlying deviations evidence-resolved; follow-up remains in #121.
- The independent Arena UI ledger now records UIR-017 complete from [PR #187's protected-main receipt](https://github.com/bynanci/courtside-tw/pull/187#issuecomment-5613249111). Its 17 tasks are not part of the canonical 112.
- Next release dependency: #164 required-context enforcement and negative proof, then a fresh T086 acceptance receipt. Participant study #110 and T087+ work remain separate.
...
- [ ] T086 Execute the staged beta release checklist and 20-run flaky-test gate in `docs/release/beta-checklist.md` and `.github/workflows/release.yml`; verify public read, two-role publish, retry, revision, withdrawal, backup restore and rollback before removing the beta flag. Current governance read-back (2026-09-12): PR #194 merged as protected `main@ac92f88a7267736325519a8bf12dc6b9ee2bcb86`; PR #161 and PR #171 are closed as superseded. The reviewed #194 candidate completed control-plane, seven-surface preflight and 20/20 stability; its Beta Release PASS consumed 18 bounded `RISK_ACCEPTED_FOR_BETA` adjudications in #160 comment 5618664464, not evidence-resolution of those deviations. Current-main CI 5/5 and Security 8/8 pass, but the successful `Recompute trusted T086 gate` wrapper is not a final-decision PASS. #164 still lacks the required stable context in ruleset 20822671, post-mutation read-back and live invalidation/negative-mergeability proof. T086 remains unchecked until complete current-candidate release acceptance and its separate owner receipt. The beta flag remains unchanged.
