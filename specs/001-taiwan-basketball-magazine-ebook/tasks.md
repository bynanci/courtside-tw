...
- [x] T004 [P] Scaffold the Nuxt 4.5 application with Node.js 24 LTS in `apps/web/package.json`, `apps/web/nuxt.config.ts`, `apps/web/tsconfig.json`, and `apps/web/app/app.vue`; verify SSR returns HTML from a smoke route. Completion proof: PR #15 merged to `main` as `dec6368`, with post-merge read-back in `.loop/evidence/t004-completion-receipt.json`.
