...
- [ ] T082 Create production deployment, expand/migrate/contract migration and rollback runbooks in `infra/deployment/`, `infra/docker/`, `docs/operations/deployment.md`, and `docs/operations/rollback.md`; test application rollback without destructive schema rollback. HOLD (2026-08-23): PR #122 merged at `9fad116fb46817c4cf742c705e4113a9dc92d252`, but a post-merge review against exact implementation head `fffbf343d34c41f075ee5f8d077c8e5875e28a8a` opened 7 unresolved threads (6 P1, 1 P2) covering datasource environment binding, mandatory readiness checks, deployment-state／receipt environment binding, rollback-target eligibility, live schema read-back and bounded state history. PR #123 closeout at `af7823d0a4b2b3630fde37ea1772a60ef761e4ed` is therefore invalidated. Re-check only after attributable remediation, all seven threads resolved, fresh exact-head CI／Security／browser gates and protected-main read-back; production activation, secrets, T083+, Web3 and participant research remain out of scope.
