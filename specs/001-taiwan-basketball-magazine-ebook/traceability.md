...
| FR-009      | US1/US2 / public-reading                 | T031, T041                                                                                                 | COMPLETE       | PARTIAL         | `P_ISSUE_SEO`, `P_ARTICLE_SEO`, `P_SITEMAP` | `DEV-T085-039` | BLOCKS_T086_UNLESS_ADJUDICATED      |
...
| DEV-T085-030 | EDITORIAL_CAPABILITY_GAP | HIGH    | OPEN     | FR-011                                                                         | Keep PARTIAL and require separately scoped editorial capability remediation. Target: Editorial capability remediation. | BLOCKS_T086_UNLESS_ADJUDICATED |
| DEV-T085-031 | AUDIT_COVERAGE_GAP      | HIGH     | OPEN     | FR-019                                                                         | Keep PARTIAL and require separately scoped audit coverage remediation. Target: Audit coverage remediation. | BLOCKS_T086_UNLESS_ADJUDICATED |
| DEV-T085-032 | ASSET_REVOCATION_OFFLINE_IMPACT_GAP | HIGH | OPEN | FR-025                                                                         | Keep PARTIAL and require separately scoped asset/offline revocation remediation. Target: Asset revocation remediation. | BLOCKS_T086_UNLESS_ADJUDICATED |
| DEV-T085-033 | TAXONOMY_SCOPE_GAP      | MEDIUM   | OPEN     | FR-026, FR-027                                                                 | Keep PARTIAL until the P2 taxonomy slice is completed. Target: P2 taxonomy completion. | BLOCKS_P2_ACCEPTANCE_NOT_T085  |
| DEV-T085-034 | SEARCH_CAPABILITY_GAP   | MEDIUM   | OPEN     | FR-028, FR-029                                                                 | Keep PARTIAL until the P2 search slice is completed. Target: P2 search completion. | BLOCKS_P2_ACCEPTANCE_NOT_T085  |
| DEV-T085-035 | RATE_LIMIT_ENFORCEMENT_GAP | HIGH  | OPEN     | FR-041                                                                         | Keep PARTIAL and require separately scoped enforcement remediation. Target: P1 security remediation. | BLOCKS_T086_UNLESS_ADJUDICATED |
| DEV-T085-036 | NO_JS_ACCEPTANCE_GAP    | HIGH     | OPEN     | SC-003, SC-013                                                                 | Keep PARTIAL until a clause-complete no-JavaScript acceptance test exists. Target: T086 reader acceptance. | BLOCKS_T086_UNLESS_ADJUDICATED |
| DEV-T085-037 | WRITE_API_CONTRACT_COVERAGE_GAP | HIGH | OPEN | FR-042                                                                         | Keep PARTIAL until endpoint-complete contract coverage is captured. Target: T086 API contract acceptance. | BLOCKS_T086_UNLESS_ADJUDICATED |
| DEV-T085-038 | TASK_SOURCE_DRIFT       | MEDIUM   | OPEN     | T032, T042                                                                     | Keep the evidence-backed mapping and record the source drift without modifying runtime or historical task prose. Target: Documentation reconciliation. | NONE                           |
| DEV-T085-039 | SEO_PROOF_COVERAGE_GAP  | MEDIUM   | OPEN     | FR-009                                                                         | Keep FR-009 PARTIAL until a separately scoped issue-page output test proves Open Graph and structured data. Target: T086 reader and issue SEO acceptance. | BLOCKS_T086_UNLESS_ADJUDICATED |
| DEV-T085-040 | ISSUE_WORKFLOW_COMPLETENESS_GAP | HIGH | OPEN | FR-013                                                                         | Keep FR-013 PARTIAL until a separately scoped issue lifecycle and archive remediation has end-to-end proof. Target: P1 editorial workflow remediation. | BLOCKS_T086_UNLESS_ADJUDICATED |
| DEV-T085-041 | PUBLIC_ISSUE_LIST_FIELD_PROOF_GAP | MEDIUM | OPEN | FR-001 | Keep FR-001 PARTIAL until one public-list contract test exercises both missing fields. Target: T086 public issue contract acceptance. | BLOCKS_T086_UNLESS_ADJUDICATED |
| DEV-T085-042 | PUBLICATION_ROLE_BOUNDARY_PROOF_GAP | HIGH | OPEN | FR-014 | Keep FR-014 PARTIAL until the complete role-transition matrix has attributable acceptance proof. Target: P1 editorial role acceptance. | BLOCKS_T086_UNLESS_ADJUDICATED |
| DEV-T085-043 | PUBLICATION_IDEMPOTENCY_AND_REVISION_GATE_PROOF_GAP | HIGH | OPEN | FR-016 | Keep FR-016 PARTIAL until production issue-publish idempotency and the non-vacuous approved-revision snapshot boundary are executable. Target: P1 publication acceptance. | BLOCKS_T086_UNLESS_ADJUDICATED |
| DEV-T085-044 | PUBLICATION_RIGHTS_CLAUSE_PROOF_GAP | HIGH | OPEN | FR-023 | Keep FR-023 PARTIAL until UNKNOWN and wrong-channel workflow boundaries have attributable proof. Target: P1 rights acceptance. | BLOCKS_T086_UNLESS_ADJUDICATED |
| DEV-T085-045 | OIDC_PASSWORD_STORAGE_PROOF_GAP | HIGH | OPEN | FR-031 | Keep FR-031 PARTIAL until the negative identity-storage contract is executable. Target: P1 identity storage acceptance. | BLOCKS_T086_UNLESS_ADJUDICATED |
| DEV-T085-046 | CANONICAL_ROLE_MATRIX_PROOF_GAP | HIGH | OPEN | FR-032 | Keep FR-032 PARTIAL until the complete canonical role matrix has executable proof. Target: P1 authorization acceptance. | BLOCKS_T086_UNLESS_ADJUDICATED |
| DEV-T085-047 | CREATIVE_RUNTIME_FAILURE_FALLBACK_PROOF_GAP | HIGH | OPEN | FR-048 | Keep FR-048 PARTIAL until the runtime failure path has executable static-fallback proof. Target: T086 creative runtime acceptance. | BLOCKS_T086_UNLESS_ADJUDICATED |
...
```json
{
  ...
  "requirements": [
    ...
    },
    {
      ...
      "proofs": [
        ...
        {
          "id": "P_ISSUE_VISIBILITY",
          "kind": "REPOSITORY_PROOF",
          "path": "apps/api/src/test/java/tw/basketball/magazine/publication/PublicIssueApiIT.java",
          "selector": "listsOnlyPublishedRightsValidIssuesWithBoundedOpaqueKeysetPaginationAndEtags"
        },
        {
          "id": "P_ISSUE_DETAIL_VISIBILITY",
          "kind": "REPOSITORY_PROOF",
          "path": "apps/api/src/test/java/tw/basketball/magazine/publication/PublicIssueApiIT.java",
          "selector": "returnsVisibleSectionsAndArticlesInEditorOrderWithoutDraftMetadata"
        },
        {
          ...
          "kind": "REPOSITORY_PROOF",
          "path": "apps/api/src/test/java/tw/basketball/magazine/publication/PublicIssueApiIT.java",
          "selector": "rejectsAFuturePublishedIssueInsteadOfLeakingScheduledMetadata"
        },
        {
          "id": "P_ARTICLE_MEDIA_VISIBILITY",
          "kind": "REPOSITORY_PROOF",
          "path": "apps/api/src/test/java/tw/basketball/magazine/content/api/PublicArticleApiIT.java",
          "selector": "deniesDraftWithdrawnHistoricalAndPrivateRightsContent"
        }
      ],
      "deviation_ids": [],
      "release_impact": "NONE_FOR_CURRENT_SLICE"
    ...
    },
    {
      ...
      "proofs": [
        ...
        {
          "id": "P_WORKFLOW_SCHEDULE",
          "kind": "REPOSITORY_PROOF",
          "path": "apps/api/src/test/java/tw/basketball/magazine/publication/domain/PublicationWorkflowTest.java",
          "selector": "publisherCanScheduleThenPublishOnlyWhenDue"
        },
        {
          "id": "P_WORKFLOW_ARCHIVE",
          "kind": "REPOSITORY_PROOF",
          "path": "apps/api/src/test/java/tw/basketball/magazine/publication/domain/PublicationWorkflowTest.java",
          "selector": "publishedCanArchiveDirectly"
        },
        {
  ...
  "deviations": [
    ...
    },
    {
      ...
      "severity": "MEDIUM",
      "affected_ids": ["FR-009"],
      "expected": "Public issue and article pages each have canonical Open Graph structured-data and sitemap acceptance proof.",
      "observed": "Article SEO and sitemap proof are complete, while the issue-page selector proves canonical output but its Open Graph and JSON-LD assertions apply only to Home.",
      "disposition": "Keep FR-009 PARTIAL until a separately scoped issue-page output test proves Open Graph and structured data.",
      "owner": "T085 release owner",
      "target": "T086 reader and issue SEO acceptance",
      "release_impact": "BLOCKS_T086_UNLESS_ADJUDICATED",
      "state": "OPEN"
    },
    {
      ...
      "severity": "HIGH",
      "affected_ids": ["FR-013"],
      "expected": "Article and issue editorial APIs both enforce DRAFT to IN_REVIEW to APPROVED to SCHEDULED or PUBLISHED to ARCHIVED.",
      "observed": "Article tests cover the full chain, while issue integration directly seeds APPROVED and proves only schedule and publish; no issue archive API or service operation exists.",
