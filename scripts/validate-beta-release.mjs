...
export const T086_AUTHORIZED_BASE_SHA = "7598d64780558915ba88b83ee9fcbcc22ab7c600"
...
export const EXPECTED_OWNER_AUTHORIZATION = Object.freeze({
  ...
  task: "T086",
  issue: "https://github.com/bynanci/courtside-tw/issues/193",
  branch: "agent/t086-release-control-plane-7598d647",
  authorization_base: {
    branch: "main",
...
function validateOwnerAuthorization(readback, errors, required) {
  ...
  if (
    ...
    readback.issue_url !== "https://api.github.com/repos/bynanci/courtside-tw/issues/193"
  ) {
    errors.push("owner authorization source is not the pinned issue 193 comment")
  }
...
const githubIssueCommentsFetchScript = [
  ...
  "const headers = { Accept: 'application/vnd.github+json', 'User-Agent': 'courtside-t086-release-validator', 'X-GitHub-Api-Version': '2022-11-28' }",
  "const allowedCommentPaths = new Set([initialUrl.pathname, '/repositories/1324872306/issues/160/comments'])",
  ...
  "    if (candidate.origin !== initialUrl.origin || !allowedCommentPaths.has(candidate.pathname)) throw new Error('GitHub owner adjudication pagination escaped the issue comments endpoint')",
