...
@ConditionalOnBean({MediaAssetRepository.class, PrivateObjectReader.class, MediaProcessingService.class})
public final class MediaWorkerConfiguration {
    ...
    public EditorialMediaOutboxHandler editorialMediaOutboxHandler(
        ...
        return new EditorialMediaOutboxHandler(
                assetRepository, privateObjectReader, processingService, objectMapper
        );
    }
