...
type FakeCache = {
  ...
  match: (request: CacheRequest, options?: { ignoreSearch?: boolean }) => Promise<Response | undefined>
...
function navigateRequest(pathname: string, search = ""): { method: string; mode: string; url: string } {
  return {
    method: "GET",
    mode: "navigate",
