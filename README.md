...
- T006 已完成：PR #20 合併 shared quality gates，PR #21 完成 T006 checkbox／Graphify completion；最终 main read-back 见 `.loop/evidence/t006-main-readback.json`。T007 是下一個未勾選 slice，但尚未 dispatch，後續工作維持未啟動。
